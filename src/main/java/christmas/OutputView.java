...
public class OutputView {
        ...
        public void benefit(int totalOrderAmount, int benefitDetailsdday,int benefitDetailsweekday,int benefitDetailsweekend,int benefitDetailsSpecial,int benefitDetailsGift){
