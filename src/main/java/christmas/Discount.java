...
public class Discount {
    ...
    public int benefitDetailsdday(int date){
         if(date>=1&&date<=25){
    ...
    public int benefitDetailsweekday(int date, List<String> menuList){
    ...
    public int benefitDetailsweekend(int date, List<String> menuList){
    ...
    public int benefitDetailsSpecial(int date){
        if(date%7==3||date==25){
